...
const Simulation = () => {
  ...
  return (
    <div>
    <Navbar />
    <div className="max-w-screen-lg px-4 mb-16 py-4 mx-auto lg:gap-8 xl:gap-0 lg:flex justify-between">

        <div className="lg:col-span-5">
          <h1 className="text-sky-800 text-sm ml-8 font-bold font-['DM Sans'] uppercase leading-tight tracking-widest">Simulasi</h1>
          <p className="text-gray-700 text-4xl mt-3 mb-8 font-bold font-['DM Sans'] leading-10">Tertarik melakukan investasi? <br/> coba hitung simulasi DPLK</p>
