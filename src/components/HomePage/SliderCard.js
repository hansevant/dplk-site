    ...
    return (
        <div className='p-4'>
            <div className="bg-white rounded-lg shadow-md p-4 text-left gap-y-4 flex flex-col">
                ...
                <p className="w-72 h-36 text-slate-500 text-base font-normal font-['DM Sans'] leading-normal">Saya sangat senang dengan pelayanan yang diberikan oleh DPLK BRI. Tim mereka sangat profesional dan membantu saya dengan semua pertanyaan saya mengenai dana pensiun saya. </p>
